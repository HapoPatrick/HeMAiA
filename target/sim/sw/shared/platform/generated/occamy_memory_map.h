...
#define soc_ctrl_scratch_base     (SOC_CTRL_BASE_ADDR + OCCAMY_SOC_SCRATCH_0_REG_OFFSET)

#define cluster_clint_set_base                   (QUADRANT_0_CLUSTER_0_PERIPH_BASE_ADDR +      SNITCH_CLUSTER_PERIPHERAL_CL_CLINT_SET_REG_OFFSET)
#define cluster_clint_clr_base                   (QUADRANT_0_CLUSTER_0_PERIPH_BASE_ADDR +      SNITCH_CLUSTER_PERIPHERAL_CL_CLINT_CLEAR_REG_OFFSET)

#define cluster_hw_barrier_base                  (QUADRANT_0_CLUSTER_0_PERIPH_BASE_ADDR +      SNITCH_CLUSTER_PERIPHERAL_HW_BARRIER_REG_OFFSET)

#define cluster_zero_memory_base QUADRANT_0_CLUSTER_0_ZERO_MEM_BASE_ADDR

#define quad_cfg_reset_n_base     (QUAD_0_CFG_BASE_ADDR + OCCAMY_QUADRANT_S1_RESET_N_REG_OFFSET)

#define quad_cfg_clk_ena_base     (QUAD_0_CFG_BASE_ADDR + OCCAMY_QUADRANT_S1_CLK_ENA_REG_OFFSET)

#define quad_cfg_isolate_base     (QUAD_0_CFG_BASE_ADDR + OCCAMY_QUADRANT_S1_ISOLATE_REG_OFFSET)

#define quad_cfg_isolated_base     (QUAD_0_CFG_BASE_ADDR + OCCAMY_QUADRANT_S1_ISOLATED_REG_OFFSET)

#define quad_cfg_ro_cache_enable_base     (QUAD_0_CFG_BASE_ADDR + OCCAMY_QUADRANT_S1_RO_CACHE_ENABLE_REG_OFFSET)

#define quad_cfg_ro_cache_addr_rule_base     (QUAD_0_CFG_BASE_ADDR + OCCAMY_QUADRANT_S1_RO_START_ADDR_LOW_0_REG_OFFSET)

//===============================================================
// Replicated address spaces
//===============================================================

#define cluster_offset 0x400000
