...
assign SocAxiLitePeriphXbarAddrmap = '{
  '{ idx: 0, start_addr: {chip_id_i,40'h01000000}, end_addr: {chip_id_i,40'h1200000000} },
  '{ idx: 1, start_addr: {chip_id_i,40'h00000000}, end_addr: {chip_id_i,40'h00001000} }
};

axi_lite_a48_d64_req_t [2:0] soc_axi_lite_periph_xbar_in_req;
axi_lite_a48_d64_rsp_t [2:0] soc_axi_lite_periph_xbar_in_rsp;
...
xbar_rule_48_t [9:0] SocAxiLiteNarrowPeriphXbarAddrmap;
assign SocAxiLiteNarrowPeriphXbarAddrmap = '{
  '{ idx: 0, start_addr: {chip_id_i,40'h02000000}, end_addr: {chip_id_i,40'h02001000} },
  '{ idx: 1, start_addr: {chip_id_i,40'h02002000}, end_addr: {chip_id_i,40'h02003000} },
  '{ idx: 2, start_addr: {chip_id_i,40'h02003000}, end_addr: {chip_id_i,40'h02004000} },
  '{ idx: 3, start_addr: {chip_id_i,40'h02004000}, end_addr: {chip_id_i,40'h02005000} },
  '{ idx: 4, start_addr: {chip_id_i,40'h02005000}, end_addr: {chip_id_i,40'h02006000} },
  '{ idx: 5, start_addr: {chip_id_i,40'h02006000}, end_addr: {chip_id_i,40'h02007000} },
  '{ idx: 6, start_addr: {chip_id_i,40'h03000000}, end_addr: {chip_id_i,40'h03020000} },
  '{ idx: 7, start_addr: {chip_id_i,40'h0c000000}, end_addr: {chip_id_i,40'h10000000} },
  '{ idx: 8, start_addr: {chip_id_i,40'h01000000}, end_addr: {chip_id_i,40'h01020000} },
  '{ idx: 9, start_addr: {chip_id_i,40'h04000000}, end_addr: {chip_id_i,40'h04100000} }
};
...
axi_lite_a48_d32_req_t [9:0] soc_axi_lite_narrow_periph_xbar_out_req;
axi_lite_a48_d32_rsp_t [9:0] soc_axi_lite_narrow_periph_xbar_out_rsp;
...
axi_lite_xbar #(
  ...
  axi_a48_d64_i6_u3_req_t periph_axi_lite_soc2per_req;
  axi_a48_d64_i6_u3_resp_t periph_axi_lite_soc2per_rsp;

  axi_a48_d64_i4_u3_req_t periph_axi_lite_per2soc_req;
  axi_a48_d64_i4_u3_resp_t periph_axi_lite_per2soc_rsp;

  axi_a48_d64_i6_u3_req_t periph_regbus_soc2per_req;
  axi_a48_d64_i6_u3_resp_t periph_regbus_soc2per_rsp;
  ...
  // Connect AXI-lite master
    axi_a48_d64_i6_u3_req_t axi_lite_from_soc_cdc_req;
  axi_a48_d64_i6_u3_resp_t axi_lite_from_soc_cdc_rsp;
  ...
  axi_to_axi_lite #(
    ...
    .AxiMaxReadTxns ( 4  ),
    .FallThrough ( 0  ),
    .full_req_t ( axi_a48_d64_i6_u3_req_t ),
    .full_resp_t ( axi_a48_d64_i6_u3_resp_t ),
  ...
  axi_lite_to_axi #(
    ...
    axi_a48_d64_i6_u3_req_t periph_cdc_req;
  axi_a48_d64_i6_u3_resp_t periph_cdc_rsp;
  ...
  axi_a48_d32_i6_u3_req_t axi_to_axi_lite_dw_req;
  axi_a48_d32_i6_u3_resp_t axi_to_axi_lite_dw_rsp;
  ...
  axi_dw_converter #(
    ...
    .AxiAddrWidth ( 48 ),
    .AxiIdWidth ( 6 ),
    .aw_chan_t ( axi_a48_d32_i6_u3_aw_chan_t ),
    .mst_w_chan_t ( axi_a48_d32_i6_u3_w_chan_t ),
    .slv_w_chan_t ( axi_a48_d64_i6_u3_w_chan_t ),
    .b_chan_t ( axi_a48_d32_i6_u3_b_chan_t ),
    .ar_chan_t ( axi_a48_d32_i6_u3_ar_chan_t ),
    .mst_r_chan_t ( axi_a48_d32_i6_u3_r_chan_t ),
    .slv_r_chan_t ( axi_a48_d64_i6_u3_r_chan_t ),
    .axi_mst_req_t ( axi_a48_d32_i6_u3_req_t ),
    .axi_mst_resp_t ( axi_a48_d32_i6_u3_resp_t ),
    .axi_slv_req_t ( axi_a48_d64_i6_u3_req_t ),
    .axi_slv_resp_t ( axi_a48_d64_i6_u3_resp_t )
  ...
  axi_to_axi_lite #(
    ...
    .AxiMaxReadTxns ( 4  ),
    .FallThrough ( 0  ),
    .full_req_t ( axi_a48_d32_i6_u3_req_t ),
    .full_resp_t ( axi_a48_d32_i6_u3_resp_t ),
  ...
  occamy_spi_slave #(
    ...
    .rst_ni(rst_periph_ni),
    .chip_id_i(chip_id_i),
    .axi_lite_req_o(soc_axi_lite_periph_xbar_in_req[SOC_AXI_LITE_PERIPH_XBAR_IN_SPIS]),
    .axi_lite_rsp_i(soc_axi_lite_periph_xbar_in_rsp[SOC_AXI_LITE_PERIPH_XBAR_IN_SPIS]),
