...
#(
  ...
  output logic [3:0] clk_quadrant_cluster_o,
  ...
  output axi_a48_d64_i4_u3_req_t soc_out_req_o,
  input  axi_a48_d64_i4_u3_resp_t soc_out_rsp_i,
  input  axi_a48_d64_i6_u3_req_t soc_in_req_i,
  output axi_a48_d64_i6_u3_resp_t soc_in_rsp_o,

  // TLB narrow and wide configuration ports

  // Quadrant narrow ports
  output axi_a48_d64_i6_u3_req_t quadrant_out_req_o,
  input  axi_a48_d64_i6_u3_resp_t quadrant_out_rsp_i,
  input  axi_a48_d64_i4_u3_req_t quadrant_in_req_i,
  output axi_a48_d64_i4_u3_resp_t quadrant_in_rsp_o
);
...
axi_xbar #(
  ...
  .Connectivity  ( 2'b11 ),
  .ATOPs         ( 1 ),
  .slv_aw_chan_t ( axi_a48_d64_i6_u3_aw_chan_t ),
  .mst_aw_chan_t ( axi_a48_d64_i6_u3_aw_chan_t ),
  .w_chan_t      ( axi_a48_d64_i6_u3_w_chan_t ),
  .slv_b_chan_t  ( axi_a48_d64_i6_u3_b_chan_t ),
  .mst_b_chan_t  ( axi_a48_d64_i6_u3_b_chan_t ),
  .slv_ar_chan_t ( axi_a48_d64_i6_u3_ar_chan_t ),
...
axi_xbar #(
  ...
  .mst_aw_chan_t ( axi_a48_d64_i4_u3_aw_chan_t ),
  .w_chan_t      ( axi_a48_d64_i4_u3_w_chan_t ),
  .slv_b_chan_t  ( axi_a48_d64_i4_u3_b_chan_t ),
  .mst_b_chan_t  ( axi_a48_d64_i4_u3_b_chan_t ),
  .slv_ar_chan_t ( axi_a48_d64_i4_u3_ar_chan_t ),
  .mst_ar_chan_t ( axi_a48_d64_i4_u3_ar_chan_t ),
...
axi_lite_xbar #(
  ...
  // Convert both internal ports to AXI lite, since only registers for now
    axi_a48_d64_i1_u3_req_t soc_to_quad_internal_ser_req;
  axi_a48_d64_i1_u3_resp_t soc_to_quad_internal_ser_rsp;
  ...
  axi_id_serialize #(
    ...
    .slv_req_t (axi_a48_d64_i6_u3_req_t),
    .slv_resp_t (axi_a48_d64_i6_u3_resp_t),
    .mst_req_t (axi_a48_d64_i1_u3_req_t),
    .mst_resp_t (axi_a48_d64_i1_u3_resp_t)
  ...
  axi_a48_d32_i1_u3_req_t axi_to_axi_lite_dw_req;
  axi_a48_d32_i1_u3_resp_t axi_to_axi_lite_dw_rsp;
  ...
  axi_dw_converter #(
    ...
    .AxiAddrWidth ( 48 ),
    .AxiIdWidth ( 1 ),
    .aw_chan_t ( axi_a48_d32_i1_u3_aw_chan_t ),
    .mst_w_chan_t ( axi_a48_d32_i1_u3_w_chan_t ),
    .slv_w_chan_t ( axi_a48_d64_i1_u3_w_chan_t ),
    .b_chan_t ( axi_a48_d32_i1_u3_b_chan_t ),
    .ar_chan_t ( axi_a48_d32_i1_u3_ar_chan_t ),
    .mst_r_chan_t ( axi_a48_d32_i1_u3_r_chan_t ),
    .slv_r_chan_t ( axi_a48_d64_i1_u3_r_chan_t ),
    .axi_mst_req_t ( axi_a48_d32_i1_u3_req_t ),
    .axi_mst_resp_t ( axi_a48_d32_i1_u3_resp_t ),
    .axi_slv_req_t ( axi_a48_d64_i1_u3_req_t ),
    .axi_slv_resp_t ( axi_a48_d64_i1_u3_resp_t )
  ...
  axi_to_axi_lite #(
    ...
    .AxiMaxReadTxns ( 4  ),
    .FallThrough ( 0  ),
    .full_req_t ( axi_a48_d32_i1_u3_req_t ),
    .full_resp_t ( axi_a48_d32_i1_u3_resp_t ),
  ...
  axi_a48_d64_i1_u3_req_t soc_internal_serialize_req;
  axi_a48_d64_i1_u3_resp_t soc_internal_serialize_rsp;
  ...
  axi_a48_d32_i1_u3_req_t soc_internal_change_dw_req;
  axi_a48_d32_i1_u3_resp_t soc_internal_change_dw_rsp;
  ...
  tc_clk_gating i_tc_clk_gating_quadrant_cluster_0 (
    .clk_i,
    .en_i (reg2hw.clk_ena.ena_cluster_0.q),
    .test_en_i (test_mode_i),
    .clk_o (clk_quadrant_cluster_o[0])
  );
  tc_clk_gating i_tc_clk_gating_quadrant_cluster_1 (
    .clk_i,
    .en_i (reg2hw.clk_ena.ena_cluster_1.q),
    .test_en_i (test_mode_i),
    .clk_o (clk_quadrant_cluster_o[1])
  );
  tc_clk_gating i_tc_clk_gating_quadrant_cluster_2 (
    .clk_i,
    .en_i (reg2hw.clk_ena.ena_cluster_2.q),
    .test_en_i (test_mode_i),
    .clk_o (clk_quadrant_cluster_o[2])
  );
  tc_clk_gating i_tc_clk_gating_quadrant_cluster_3 (
    .clk_i,
    .en_i (reg2hw.clk_ena.ena_cluster_3.q),
    .test_en_i (test_mode_i),
    .clk_o (clk_quadrant_cluster_o[3])
  );
