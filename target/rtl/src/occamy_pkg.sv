...
package occamy_pkg;
  ...
  localparam int unsigned NrCoresCluster [NrClustersS1Quadrant] = '{2,2,2,2};
  localparam int unsigned NrCoresClusterOffset [NrClustersS1Quadrant] = '{0,2,4,6};
  localparam int unsigned NrCoresS1Quadrant = 8;
  ...
  localparam addr_t ClusterAddressSpace = 'h40_0000;
...
`AXI_LITE_TYPEDEF_ALL_CT(axi_lite_a48_d64, axi_lite_a48_d64_req_t, axi_lite_a48_d64_rsp_t, logic [47:0], logic [63:0],             logic [7:0])

/// Inputs of the `soc_axi_lite_periph_xbar` crossbar.
typedef enum int {
  SOC_AXI_LITE_PERIPH_XBAR_IN_SOC,
  SOC_AXI_LITE_PERIPH_XBAR_IN_DEBUG,
  SOC_AXI_LITE_PERIPH_XBAR_IN_SPIS,
...
`AXI_LITE_TYPEDEF_ALL_CT(axi_lite_a48_d32, axi_lite_a48_d32_req_t, axi_lite_a48_d32_rsp_t, logic [47:0], logic [31:0],             logic [3:0])
...
`AXI_TYPEDEF_ALL_CT(axi_a48_d512_i4_u0, axi_a48_d512_i4_u0_req_t, axi_a48_d512_i4_u0_resp_t, logic [47:0], logic [3:0], logic [511:0], logic [63:0], logic [0:0])

// AXI bus with 48 bit address, 512 bit data, 6 bit IDs,             and 0 bit user data.
`AXI_TYPEDEF_ALL_CT(axi_a48_d512_i6_u0, axi_a48_d512_i6_u0_req_t, axi_a48_d512_i6_u0_resp_t, logic [47:0], logic [5:0], logic [511:0], logic [63:0], logic [0:0])
...
// AXI bus with 48 bit address, 64 bit data, 4 bit IDs,             and 3 bit user data.
`AXI_TYPEDEF_ALL_CT(axi_a48_d64_i4_u3, axi_a48_d64_i4_u3_req_t, axi_a48_d64_i4_u3_resp_t, logic [47:0], logic [3:0], logic [63:0], logic [7:0], logic [2:0])

// AXI bus with 48 bit address, 64 bit data, 6 bit IDs,             and 3 bit user data.
`AXI_TYPEDEF_ALL_CT(axi_a48_d64_i6_u3, axi_a48_d64_i6_u3_req_t, axi_a48_d64_i6_u3_resp_t, logic [47:0], logic [5:0], logic [63:0], logic [7:0], logic [2:0])

typedef axi_a48_d64_i4_u3_req_t soc_narrow_xbar_in_req_t;
typedef axi_a48_d64_i6_u3_req_t soc_narrow_xbar_out_req_t;
typedef axi_a48_d64_i4_u3_resp_t soc_narrow_xbar_in_resp_t;
typedef axi_a48_d64_i6_u3_resp_t soc_narrow_xbar_out_resp_t;
typedef axi_a48_d64_i4_u3_aw_chan_t soc_narrow_xbar_in_aw_chan_t;
typedef axi_a48_d64_i6_u3_aw_chan_t soc_narrow_xbar_out_aw_chan_t;
typedef axi_a48_d64_i4_u3_w_chan_t soc_narrow_xbar_in_w_chan_t;
typedef axi_a48_d64_i6_u3_w_chan_t soc_narrow_xbar_out_w_chan_t;
typedef axi_a48_d64_i4_u3_b_chan_t soc_narrow_xbar_in_b_chan_t;
typedef axi_a48_d64_i6_u3_b_chan_t soc_narrow_xbar_out_b_chan_t;
typedef axi_a48_d64_i4_u3_ar_chan_t soc_narrow_xbar_in_ar_chan_t;
typedef axi_a48_d64_i6_u3_ar_chan_t soc_narrow_xbar_out_ar_chan_t;
typedef axi_a48_d64_i4_u3_r_chan_t soc_narrow_xbar_in_r_chan_t;
typedef axi_a48_d64_i6_u3_r_chan_t soc_narrow_xbar_out_r_chan_t;

// verilog_lint: waive parameter-name-style
localparam int SOC_NARROW_XBAR_IW_IN = 4;
// verilog_lint: waive parameter-name-style
localparam int SOC_NARROW_XBAR_IW_OUT = 6;
...
typedef axi_a48_d64_i6_u3_req_t quadrant_s1_ctrl_soc_to_quad_xbar_in_req_t;
typedef axi_a48_d64_i6_u3_req_t quadrant_s1_ctrl_soc_to_quad_xbar_out_req_t;
typedef axi_a48_d64_i6_u3_resp_t quadrant_s1_ctrl_soc_to_quad_xbar_in_resp_t;
typedef axi_a48_d64_i6_u3_resp_t quadrant_s1_ctrl_soc_to_quad_xbar_out_resp_t;
typedef axi_a48_d64_i6_u3_aw_chan_t quadrant_s1_ctrl_soc_to_quad_xbar_in_aw_chan_t;
typedef axi_a48_d64_i6_u3_aw_chan_t quadrant_s1_ctrl_soc_to_quad_xbar_out_aw_chan_t;
typedef axi_a48_d64_i6_u3_w_chan_t quadrant_s1_ctrl_soc_to_quad_xbar_in_w_chan_t;
typedef axi_a48_d64_i6_u3_w_chan_t quadrant_s1_ctrl_soc_to_quad_xbar_out_w_chan_t;
typedef axi_a48_d64_i6_u3_b_chan_t quadrant_s1_ctrl_soc_to_quad_xbar_in_b_chan_t;
typedef axi_a48_d64_i6_u3_b_chan_t quadrant_s1_ctrl_soc_to_quad_xbar_out_b_chan_t;
typedef axi_a48_d64_i6_u3_ar_chan_t quadrant_s1_ctrl_soc_to_quad_xbar_in_ar_chan_t;
typedef axi_a48_d64_i6_u3_ar_chan_t quadrant_s1_ctrl_soc_to_quad_xbar_out_ar_chan_t;
typedef axi_a48_d64_i6_u3_r_chan_t quadrant_s1_ctrl_soc_to_quad_xbar_in_r_chan_t;
typedef axi_a48_d64_i6_u3_r_chan_t quadrant_s1_ctrl_soc_to_quad_xbar_out_r_chan_t;

// verilog_lint: waive parameter-name-style
localparam int QUADRANT_S1_CTRL_SOC_TO_QUAD_XBAR_IW_IN = 6;
// verilog_lint: waive parameter-name-style
localparam int QUADRANT_S1_CTRL_SOC_TO_QUAD_XBAR_IW_OUT = 6;
...
typedef axi_a48_d64_i4_u3_req_t quadrant_s1_ctrl_quad_to_soc_xbar_in_req_t;
typedef axi_a48_d64_i4_u3_req_t quadrant_s1_ctrl_quad_to_soc_xbar_out_req_t;
typedef axi_a48_d64_i4_u3_resp_t quadrant_s1_ctrl_quad_to_soc_xbar_in_resp_t;
typedef axi_a48_d64_i4_u3_resp_t quadrant_s1_ctrl_quad_to_soc_xbar_out_resp_t;
typedef axi_a48_d64_i4_u3_aw_chan_t quadrant_s1_ctrl_quad_to_soc_xbar_in_aw_chan_t;
typedef axi_a48_d64_i4_u3_aw_chan_t quadrant_s1_ctrl_quad_to_soc_xbar_out_aw_chan_t;
typedef axi_a48_d64_i4_u3_w_chan_t quadrant_s1_ctrl_quad_to_soc_xbar_in_w_chan_t;
typedef axi_a48_d64_i4_u3_w_chan_t quadrant_s1_ctrl_quad_to_soc_xbar_out_w_chan_t;
typedef axi_a48_d64_i4_u3_b_chan_t quadrant_s1_ctrl_quad_to_soc_xbar_in_b_chan_t;
typedef axi_a48_d64_i4_u3_b_chan_t quadrant_s1_ctrl_quad_to_soc_xbar_out_b_chan_t;
typedef axi_a48_d64_i4_u3_ar_chan_t quadrant_s1_ctrl_quad_to_soc_xbar_in_ar_chan_t;
typedef axi_a48_d64_i4_u3_ar_chan_t quadrant_s1_ctrl_quad_to_soc_xbar_out_ar_chan_t;
typedef axi_a48_d64_i4_u3_r_chan_t quadrant_s1_ctrl_quad_to_soc_xbar_in_r_chan_t;
typedef axi_a48_d64_i4_u3_r_chan_t quadrant_s1_ctrl_quad_to_soc_xbar_out_r_chan_t;
...
`AXI_TYPEDEF_ALL_CT(axi_a48_d512_i3_u0, axi_a48_d512_i3_u0_req_t, axi_a48_d512_i3_u0_resp_t, logic [47:0], logic [2:0], logic [511:0], logic [63:0], logic [0:0])
...
// AXI bus with 48 bit address, 64 bit data, 7 bit IDs,             and 3 bit user data.
`AXI_TYPEDEF_ALL_CT(axi_a48_d64_i7_u3, axi_a48_d64_i7_u3_req_t, axi_a48_d64_i7_u3_resp_t, logic [47:0], logic [6:0], logic [63:0], logic [7:0], logic [2:0])

typedef axi_a48_d64_i4_u3_req_t narrow_xbar_quadrant_s1_in_req_t;
typedef axi_a48_d64_i7_u3_req_t narrow_xbar_quadrant_s1_out_req_t;
typedef axi_a48_d64_i4_u3_resp_t narrow_xbar_quadrant_s1_in_resp_t;
typedef axi_a48_d64_i7_u3_resp_t narrow_xbar_quadrant_s1_out_resp_t;
typedef axi_a48_d64_i4_u3_aw_chan_t narrow_xbar_quadrant_s1_in_aw_chan_t;
typedef axi_a48_d64_i7_u3_aw_chan_t narrow_xbar_quadrant_s1_out_aw_chan_t;
typedef axi_a48_d64_i4_u3_w_chan_t narrow_xbar_quadrant_s1_in_w_chan_t;
typedef axi_a48_d64_i7_u3_w_chan_t narrow_xbar_quadrant_s1_out_w_chan_t;
typedef axi_a48_d64_i4_u3_b_chan_t narrow_xbar_quadrant_s1_in_b_chan_t;
typedef axi_a48_d64_i7_u3_b_chan_t narrow_xbar_quadrant_s1_out_b_chan_t;
typedef axi_a48_d64_i4_u3_ar_chan_t narrow_xbar_quadrant_s1_in_ar_chan_t;
typedef axi_a48_d64_i7_u3_ar_chan_t narrow_xbar_quadrant_s1_out_ar_chan_t;
typedef axi_a48_d64_i4_u3_r_chan_t narrow_xbar_quadrant_s1_in_r_chan_t;
typedef axi_a48_d64_i7_u3_r_chan_t narrow_xbar_quadrant_s1_out_r_chan_t;
...
`AXI_TYPEDEF_ALL_CT(axi_a48_d512_i8_u0, axi_a48_d512_i8_u0_req_t, axi_a48_d512_i8_u0_resp_t, logic [47:0], logic [7:0], logic [511:0], logic [63:0], logic [0:0])

// AXI bus with 48 bit address, 32 bit data, 6 bit IDs,             and 3 bit user data.
`AXI_TYPEDEF_ALL_CT(axi_a48_d32_i6_u3, axi_a48_d32_i6_u3_req_t, axi_a48_d32_i6_u3_resp_t, logic [47:0], logic [5:0], logic [31:0], logic [3:0], logic [2:0])
...
`AXI_TYPEDEF_ALL_CT(axi_a48_d64_i4_u0, axi_a48_d64_i4_u0_req_t, axi_a48_d64_i4_u0_resp_t, logic [47:0], logic [3:0], logic [63:0], logic [7:0], logic [0:0])

// AXI bus with 48 bit address, 512 bit data, 4 bit IDs,             and 3 bit user data.
`AXI_TYPEDEF_ALL_CT(axi_a48_d512_i4_u3, axi_a48_d512_i4_u3_req_t, axi_a48_d512_i4_u3_resp_t, logic [47:0], logic [3:0], logic [511:0], logic [63:0], logic [2:0])

// AXI bus with 48 bit address, 64 bit data, 1 bit IDs,             and 3 bit user data.
`AXI_TYPEDEF_ALL_CT(axi_a48_d64_i1_u3, axi_a48_d64_i1_u3_req_t, axi_a48_d64_i1_u3_resp_t, logic [47:0], logic [0:0], logic [63:0], logic [7:0], logic [2:0])

// AXI bus with 48 bit address, 32 bit data, 1 bit IDs,             and 3 bit user data.
`AXI_TYPEDEF_ALL_CT(axi_a48_d32_i1_u3, axi_a48_d32_i1_u3_req_t, axi_a48_d32_i1_u3_resp_t, logic [47:0], logic [0:0], logic [31:0], logic [3:0], logic [2:0])

// AXI bus with 48 bit address, 512 bit data, 7 bit IDs,             and 0 bit user data.
`AXI_TYPEDEF_ALL_CT(axi_a48_d512_i7_u0, axi_a48_d512_i7_u0_req_t, axi_a48_d512_i7_u0_resp_t, logic [47:0], logic [6:0], logic [511:0], logic [63:0], logic [0:0])

// AXI bus with 48 bit address, 64 bit data, 2 bit IDs,             and 3 bit user data.
`AXI_TYPEDEF_ALL_CT(axi_a48_d64_i2_u3, axi_a48_d64_i2_u3_req_t, axi_a48_d64_i2_u3_resp_t, logic [47:0], logic [1:0], logic [63:0], logic [7:0], logic [2:0])

// AXI bus with 48 bit address, 512 bit data, 1 bit IDs,             and 0 bit user data.
`AXI_TYPEDEF_ALL_CT(axi_a48_d512_i1_u0, axi_a48_d512_i1_u0_req_t, axi_a48_d512_i1_u0_resp_t, logic [47:0], logic [0:0], logic [511:0], logic [63:0], logic [0:0])
