...
(
  ...
  // Next-Level
  output axi_a48_d64_i4_u3_req_t quadrant_narrow_out_req_o,
  input  axi_a48_d64_i4_u3_resp_t quadrant_narrow_out_rsp_i,
  input  axi_a48_d64_i6_u3_req_t quadrant_narrow_in_req_i,
  output axi_a48_d64_i6_u3_resp_t quadrant_narrow_in_rsp_o,
  output axi_a48_d512_i4_u0_req_t quadrant_wide_out_req_o,
  input  axi_a48_d512_i4_u0_resp_t quadrant_wide_out_rsp_i,
  input  axi_a48_d512_i6_u0_req_t quadrant_wide_in_req_i,
  output axi_a48_d512_i6_u0_resp_t quadrant_wide_in_rsp_o,
  // SRAM configuration
 ...
 // Calculate cluster base address based on `tile id`.
  ...
  assign cluster_base_addr[0] = cluster_base_offset + 0 * ClusterAddressSpace;
  assign cluster_base_addr[1] = cluster_base_offset + 1 * ClusterAddressSpace;
  assign cluster_base_addr[2] = cluster_base_offset + 2 * ClusterAddressSpace;
  assign cluster_base_addr[3] = cluster_base_offset + 3 * ClusterAddressSpace;
  ...
  logic [3:0] clk_quadrant_cluster;
...
axi_xbar #(
  ...
  .mst_aw_chan_t ( axi_a48_d64_i7_u3_aw_chan_t ),
  .w_chan_t      ( axi_a48_d64_i4_u3_w_chan_t ),
  .slv_b_chan_t  ( axi_a48_d64_i4_u3_b_chan_t ),
  .mst_b_chan_t  ( axi_a48_d64_i7_u3_b_chan_t ),
  .slv_ar_chan_t ( axi_a48_d64_i4_u3_ar_chan_t ),
  .mst_ar_chan_t ( axi_a48_d64_i7_u3_ar_chan_t ),
  .slv_r_chan_t  ( axi_a48_d64_i4_u3_r_chan_t ),
  .mst_r_chan_t  ( axi_a48_d64_i7_u3_r_chan_t ),
  .slv_req_t     ( axi_a48_d64_i4_u3_req_t ),
  .slv_resp_t    ( axi_a48_d64_i4_u3_resp_t ),
  .mst_req_t     ( axi_a48_d64_i7_u3_req_t ),
  .mst_resp_t    ( axi_a48_d64_i7_u3_resp_t ),
  .rule_t        ( xbar_rule_48_t )
  ...
  ///////////////////////////////
    axi_a48_d64_i6_u3_req_t narrow_cluster_in_ctrl_req;
  axi_a48_d64_i6_u3_resp_t narrow_cluster_in_ctrl_rsp;

  axi_a48_d64_i6_u3_req_t narrow_cluster_in_ctrl_cut_req;
  axi_a48_d64_i6_u3_resp_t narrow_cluster_in_ctrl_cut_rsp;
...
axi_multicut #(
  ...
  axi_a48_d64_i6_u3_req_t narrow_cluster_in_isolate_req;
  axi_a48_d64_i6_u3_resp_t narrow_cluster_in_isolate_rsp;
  ...
  /////////////////////////////////////
    axi_a48_d64_i4_u3_req_t narrow_cluster_out_iwc_req;
  axi_a48_d64_i4_u3_resp_t narrow_cluster_out_iwc_rsp;
  ...
  axi_id_remap #(
    ...
    .AxiMaxTxnsPerId ( 4 ),
    .AxiMstPortIdWidth ( 4 ),
    .slv_req_t ( axi_a48_d64_i7_u3_req_t ),
    .slv_resp_t ( axi_a48_d64_i7_u3_resp_t ),
    .mst_req_t ( axi_a48_d64_i4_u3_req_t ),
    .mst_resp_t ( axi_a48_d64_i4_u3_resp_t )
  ...
  axi_a48_d64_i4_u3_req_t narrow_cluster_out_isolate_req;
  axi_a48_d64_i4_u3_resp_t narrow_cluster_out_isolate_rsp;
  ...
  axi_a48_d64_i4_u3_req_t narrow_cluster_out_ctrl_req;
  axi_a48_d64_i4_u3_resp_t narrow_cluster_out_ctrl_rsp;
...
axi_multicut #(
  ...
  ////////////////////////////
    axi_a48_d512_i6_u0_req_t wide_cluster_in_iwc_req;
  axi_a48_d512_i6_u0_resp_t wide_cluster_in_iwc_rsp;

  axi_a48_d512_i6_u0_req_t wide_cluster_in_iwc_cut_req;
  axi_a48_d512_i6_u0_resp_t wide_cluster_in_iwc_cut_rsp;
...
axi_multicut #(
  ...
  axi_a48_d512_i6_u0_req_t wide_cluster_in_isolate_req;
  axi_a48_d512_i6_u0_resp_t wide_cluster_in_isolate_rsp;
  ...
  axi_a48_d512_i6_u0_req_t wide_cluster_in_isolate_cut_req;
  axi_a48_d512_i6_u0_resp_t wide_cluster_in_isolate_cut_rsp;
...
axi_multicut #(
  ...
  // Cluster 0 //
  ///////////////
    axi_a48_d64_i2_u3_req_t narrow_in_iwc_0_req;
  axi_a48_d64_i2_u3_resp_t narrow_in_iwc_0_rsp;
  ...
  axi_id_remap #(
    ...
    .slv_req_t ( axi_a48_d64_i7_u3_req_t ),
    .slv_resp_t ( axi_a48_d64_i7_u3_resp_t ),
    .mst_req_t ( axi_a48_d64_i2_u3_req_t ),
    .mst_resp_t ( axi_a48_d64_i2_u3_resp_t )
  ) i_narrow_in_iwc_0 (
    .clk_i ( clk_quadrant_uncore ),
    .rst_ni ( rst_quadrant_n ),
  ...
  assign hart_base_id_0 = HartIdOffset + NrCoresClusterOffset[0];

  snax_KUL_cluster_wrapper i_occamy_cluster_0 (
    .clk_i (clk_quadrant_cluster[0]),
    .rst_ni (rst_quadrant_n),
    .meip_i (meip_i[NrCoresClusterOffset[0]+:NrCoresCluster[0]]),
    .mtip_i (mtip_i[NrCoresClusterOffset[0]+:NrCoresCluster[0]]),
    .msip_i (msip_i[NrCoresClusterOffset[0]+:NrCoresCluster[0]]),
  ...
  // Cluster 1 //
  ///////////////
    axi_a48_d64_i2_u3_req_t narrow_in_iwc_1_req;
  axi_a48_d64_i2_u3_resp_t narrow_in_iwc_1_rsp;
  ...
  axi_a48_d64_i4_u3_req_t narrow_out_1_req;
  axi_a48_d64_i4_u3_resp_t narrow_out_1_rsp;
  ...
  assign hart_base_id_1 = HartIdOffset + NrCoresClusterOffset[1];

  // snax_hypercorex_cluster_wrapper i_occamy_cluster_1 (
  //   .clk_i (clk_quadrant_cluster[1]),
  //   .rst_ni (rst_quadrant_n),
  //   .meip_i (meip_i[NrCoresClusterOffset[1]+:NrCoresCluster[1]]),
  //   .mtip_i (mtip_i[NrCoresClusterOffset[1]+:NrCoresCluster[1]]),
  //   .msip_i (msip_i[NrCoresClusterOffset[1]+:NrCoresCluster[1]]),
  ...
  //   .sram_cfgs_i (sram_cfg_i.cluster)
  // );
  snax_KUL_cluster_wrapper i_occamy_cluster_1 (
    .clk_i (clk_quadrant_cluster[1]),
    .rst_ni (rst_quadrant_n),
    .meip_i (meip_i[NrCoresClusterOffset[1]+:NrCoresCluster[1]]),
    .mtip_i (mtip_i[NrCoresClusterOffset[1]+:NrCoresCluster[1]]),
  ...
  // Cluster 2 //
  ///////////////
    axi_a48_d64_i2_u3_req_t narrow_in_iwc_2_req;
  axi_a48_d64_i2_u3_resp_t narrow_in_iwc_2_rsp;
  ...
  axi_a48_d64_i4_u3_req_t narrow_out_2_req;
  axi_a48_d64_i4_u3_resp_t narrow_out_2_rsp;
  ...
  assign hart_base_id_2 = HartIdOffset + NrCoresClusterOffset[2];

  snax_hypercorex_cluster_wrapper i_occamy_cluster_2 (
    .clk_i (clk_quadrant_cluster[2]),
    .rst_ni (rst_quadrant_n),
    .meip_i (meip_i[NrCoresClusterOffset[2]+:NrCoresCluster[2]]),
    .mtip_i (mtip_i[NrCoresClusterOffset[2]+:NrCoresCluster[2]]),
    .msip_i (msip_i[NrCoresClusterOffset[2]+:NrCoresCluster[2]]),
  ...
  // Cluster 3 //
  ///////////////
    axi_a48_d64_i2_u3_req_t narrow_in_iwc_3_req;
  axi_a48_d64_i2_u3_resp_t narrow_in_iwc_3_rsp;
  ...
  axi_a48_d64_i4_u3_req_t narrow_out_3_req;
  axi_a48_d64_i4_u3_resp_t narrow_out_3_rsp;
  ...
  assign hart_base_id_3 = HartIdOffset + NrCoresClusterOffset[3];

  snax_hypercorex_cluster_wrapper i_occamy_cluster_3 (
    .clk_i (clk_quadrant_cluster[3]),
    .rst_ni (rst_quadrant_n),
    .meip_i (meip_i[NrCoresClusterOffset[3]+:NrCoresCluster[3]]),
    .mtip_i (mtip_i[NrCoresClusterOffset[3]+:NrCoresCluster[3]]),
    .msip_i (msip_i[NrCoresClusterOffset[3]+:NrCoresCluster[3]]),
