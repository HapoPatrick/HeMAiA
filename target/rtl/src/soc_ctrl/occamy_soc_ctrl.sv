...
module occamy_soc_ctrl import occamy_soc_reg_pkg::*; #(
  ...
  occamy_soc_reg_top #(
   ...
   // boot address
  logic [47:0] boot_addr_d, boot_addr_q;
  logic [47:0] boot_addr_init;
  logic [1:0] boot_mode;
  assign boot_mode = hw2reg_i.boot_mode.d;

  always_comb begin
    boot_addr_init = (boot_mode == 2'b00) ? {chip_id_i,40'h1000000}:{chip_id_i,40'h80000000};
    boot_addr_d = (boot_mode == 2'b00) ? {chip_id_i,40'h1000000}:{chip_id_i,40'h80000000};
