...
module occamy_quadrant_s1_reg_top #(
  ...
  logic clk_ena_ena_cluster_0_qs;
  logic clk_ena_ena_cluster_0_wd;
  logic clk_ena_ena_cluster_0_we;
  logic clk_ena_ena_cluster_1_qs;
  logic clk_ena_ena_cluster_1_wd;
  logic clk_ena_ena_cluster_1_we;
  logic clk_ena_ena_cluster_2_qs;
  logic clk_ena_ena_cluster_2_wd;
  logic clk_ena_ena_cluster_2_we;
  logic clk_ena_ena_cluster_3_qs;
  logic clk_ena_ena_cluster_3_wd;
  logic clk_ena_ena_cluster_3_we;
  logic clk_ena_ena_quad_uncore_qs;
  logic clk_ena_ena_quad_uncore_wd;
  logic clk_ena_ena_quad_uncore_we;
  logic reset_n_qs;
  logic reset_n_wd;
  logic reset_n_we;
  ...
  prim_subreg #(
    ...
    .SWACCESS("RW"),
    .RESVAL  (1'h0)
  ) u_clk_ena_ena_cluster_0 (
    .clk_i   (clk_i    ),
    .rst_ni  (rst_ni  ),

    // from register interface
    .we     (clk_ena_ena_cluster_0_we),
    .wd     (clk_ena_ena_cluster_0_wd),
    ...
    .qe     (),
    .q      (reg2hw.clk_ena.ena_cluster_0.q ),

    // to register interface (read)
    .qs     (clk_ena_ena_cluster_0_qs)
  );
  ...
  prim_subreg #(
    ...
    .SWACCESS("RW"),
    .RESVAL  (1'h0)
  ) u_clk_ena_ena_cluster_1 (
    .clk_i   (clk_i    ),
    .rst_ni  (rst_ni  ),

    // from register interface
    .we     (clk_ena_ena_cluster_1_we),
    .wd     (clk_ena_ena_cluster_1_wd),
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.clk_ena.ena_cluster_1.q ),

    // to register interface (read)
    .qs     (clk_ena_ena_cluster_1_qs)
  );
  ...
  prim_subreg #(
    ...
    .SWACCESS("RW"),
    .RESVAL  (1'h0)
  ) u_clk_ena_ena_cluster_2 (
    .clk_i   (clk_i    ),
    .rst_ni  (rst_ni  ),

    // from register interface
    .we     (clk_ena_ena_cluster_2_we),
    .wd     (clk_ena_ena_cluster_2_wd),
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.clk_ena.ena_cluster_2.q ),

    // to register interface (read)
    .qs     (clk_ena_ena_cluster_2_qs)
  );
  ...
  prim_subreg #(
    ...
    .SWACCESS("RW"),
    .RESVAL  (1'h0)
  ) u_clk_ena_ena_cluster_3 (
    .clk_i   (clk_i    ),
    .rst_ni  (rst_ni  ),

    // from register interface
    .we     (clk_ena_ena_cluster_3_we),
    .wd     (clk_ena_ena_cluster_3_wd),
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.clk_ena.ena_cluster_3.q ),

    // to register interface (read)
    .qs     (clk_ena_ena_cluster_3_qs)
  );


  //   F[ena_quad_uncore]: 4:4
  prim_subreg #(
    .DW      (1),
    .SWACCESS("RW"),
    .RESVAL  (1'h0)
  ) u_clk_ena_ena_quad_uncore (
    .clk_i   (clk_i    ),
    .rst_ni  (rst_ni  ),

    // from register interface
    .we     (clk_ena_ena_quad_uncore_we),
    .wd     (clk_ena_ena_quad_uncore_wd),
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.clk_ena.ena_quad_uncore.q ),

    // to register interface (read)
    .qs     (clk_ena_ena_quad_uncore_qs)
  );
  ...
  assign clk_ena_ena_cluster_0_we = addr_hit[0] & reg_we & !reg_error;
  assign clk_ena_ena_cluster_0_wd = reg_wdata[0];

  assign clk_ena_ena_cluster_1_we = addr_hit[0] & reg_we & !reg_error;
  assign clk_ena_ena_cluster_1_wd = reg_wdata[1];

  assign clk_ena_ena_cluster_2_we = addr_hit[0] & reg_we & !reg_error;
  assign clk_ena_ena_cluster_2_wd = reg_wdata[2];

  assign clk_ena_ena_cluster_3_we = addr_hit[0] & reg_we & !reg_error;
  assign clk_ena_ena_cluster_3_wd = reg_wdata[3];

  assign clk_ena_ena_quad_uncore_we = addr_hit[0] & reg_we & !reg_error;
  assign clk_ena_ena_quad_uncore_wd = reg_wdata[4];
  ...
  always_comb begin
    ...
    unique case (1'b1)
      addr_hit[0]: begin
        reg_rdata_next[0] = clk_ena_ena_cluster_0_qs;
        reg_rdata_next[1] = clk_ena_ena_cluster_1_qs;
        reg_rdata_next[2] = clk_ena_ena_cluster_2_qs;
        reg_rdata_next[3] = clk_ena_ena_cluster_3_qs;
        reg_rdata_next[4] = clk_ena_ena_quad_uncore_qs;
      end
