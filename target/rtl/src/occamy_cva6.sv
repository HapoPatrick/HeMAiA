...
module occamy_cva6 import occamy_pkg::*; (
  ...
  output axi_a48_d64_i4_u3_req_t axi_req_o,
  input  axi_a48_d64_i4_u3_resp_t axi_resp_i,
  input  sram_cfg_cva6_t    sram_cfg_i
);

    axi_a48_d64_i4_u3_req_t cva6_axi_req;
  axi_a48_d64_i4_u3_resp_t cva6_axi_rsp;

  axi_a48_d64_i4_u3_req_t cva6_axi_cut_req;
  axi_a48_d64_i4_u3_resp_t cva6_axi_cut_rsp;
...
axi_multicut #(
  ...
  localparam ariane_pkg::ariane_cfg_t CVA6OccamyConfig = '{
    ...
    NonIdempotentAddrBase: {64'd1879179264           , 64'd16908288                      , 64'h1000},
    NonIdempotentLength:   {64'd268304384, 64'd1862139904, 64'd16773120},
    NrExecuteRegionRules: 4,
    // DRAM, Boot ROM, SPM, Debug Module
    ExecuteRegionAddrBase: {64'h8000_0000, 64'd16777216, 64'd1879048192, 64'h0   },
    ExecuteRegionLength:   {(64'hff_ffff_ffff-64'h8000_0000), 64'd131072 , 64'd131072 , 64'h1000},
    // cached region
    NrCachedRegionRules:    2,
    CachedRegionAddrBase:  {64'h8000_0000, 64'd1879048192},
    CachedRegionLength:    {(64'hff_ffff_ffff-64'h8000_0000), 64'd131072},
    //  cache config
    AxiCompliant:           1'b1,
    SwapEndianess:          1'b0,
    // debug
  ...
  always_comb begin
      cva6_boot_addr = {16'h0, boot_addr_i};
  end
  sync #(.STAGES (2))
  ...
  ariane #(
    ...
    .AxiIdWidth (4),
    .AxiUserWidth (3),
    .axi_ar_chan_t(axi_a48_d64_i4_u3_ar_chan_t),
    .axi_aw_chan_t(axi_a48_d64_i4_u3_aw_chan_t),
    .axi_w_chan_t(axi_a48_d64_i4_u3_w_chan_t),
    .axi_req_t (axi_a48_d64_i4_u3_req_t),
    .axi_rsp_t (axi_a48_d64_i4_u3_resp_t),
